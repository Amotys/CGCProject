    ...
    FortalezaRaptor:
        createUnit(
            ...
            ['爬行龙巢'],
            {
                ...
                '狂暴（需要在龙之圣殿中升级）': '只能在回合开始阶段发动，这个迅猛龙将在本回合增加20点攻击力与20点伤害值，但会降低20点防御力。',
    ...
    FortalezaHammerPterosaur:
        createUnit(
            ...
            ['飞行龙巢'],
            {
                ...
                '狂暴（需要晋升至精英阶级）': '只能在回合开始阶段使用，铁锤翼龙立刻流失20%当前健康值，本回合内，这个铁锤翼龙造成的全部伤害增加40%。',
        ...
        createUnit(
            ...
            ['巨龙巢', '黑龙巢穴'],
            {
                ...
                '毁灭龙息（需要晋升至精英阶级）': '黑龙位于地面时，立刻消耗150点魔法值和一个动作宣言，并获得1层【龙息蓄力】。在【龙息蓄力】状态下的黑龙无法回复魔法值、无法被打断，' +
                    '且每个轮次开始时都要选择继续蓄力或进行吐息。若继续蓄力，黑龙获得1层【龙息蓄力】并跳过该回合，最多叠加到10层。' + '若进行吐息，则黑龙会消耗一个动作宣言会对身前90°的扇形区域的每个格子造成一次暗系魔法伤害。' +
